...
const uint8_t ONYX_TYPE_STANDARD_PROGRAM_CALL = 4;
const uint64_t ONYX_MIN_PROGRAM_DEPLOYMENT_FEE = 100000;
const uint64_t ONYX_MAX_PROGRAM_ACTIVATION_DELAY = 100000;
