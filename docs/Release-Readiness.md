...
gate. Identity comparison applies Unicode NFKC compatibility normalization before collapsing
whitespace and case, so full-width or compatibility spellings cannot inflate independence counts.
